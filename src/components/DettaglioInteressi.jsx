    ...
    <Container className="mt-3 mb-3">
      <Card>
        ...
        <Card.Body className="text-center">
          <Row>
            <Col>
              <InteressiUtente sezioneAttiva={sezioneAttiva} risultatiAttuali={renderRisultati()} />
            </Col>
          </Row>
          {/* Aggiungi un nuovo blocco Row per visualizzare tutti i risultati */}
          <Row>
            <Col>
              {renderRisultati().map((risultato) => (
                <InteressiUtente key={risultato.id} sezioneAttiva={sezioneAttiva} risultatiAttuali={[risultato]} />
              ))}
            </Col>
          </Row>
        </Card.Body>
